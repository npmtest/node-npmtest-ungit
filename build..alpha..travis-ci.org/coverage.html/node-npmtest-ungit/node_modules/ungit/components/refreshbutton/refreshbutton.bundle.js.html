...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ungit/node_modules/ungit/components/refreshbutton/refreshbutton.bundle.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ungit/node_modules/ungit/components/refreshbutton/refreshbutton.bundle.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ungit/node_modules/ungit/components/refreshbutton/</a> &#187; refreshbutton.bundle.js</div>
</div>
<div class="body">
...
28
29
30</td><td class="line-coverage"><span class="cline-any cline-yes">6</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >components.register('refreshbutton', <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  return new RefreshButton();</span>
});
&nbsp;
<span class="fstat-no" title="function not covered" >function RefreshButton() {</span>
<span class="cstat-no" title="statement not covered" >  this.refreshingProgressBar = components.create('progressBar', { predictionMemoryKey: 'refreshing-content', temporary: true });</span>
}
<span class="cstat-no" title="statement not covered" >RefreshButton.prototype.refresh = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  programEvents.dispatch({ event: 'request-app-content-refresh' });</span>
<span class="cstat-no" title="statement not covered" >  this.refreshingProgressBar.start();</span>
<span class="cstat-no" title="statement not covered" >  setTimeout(<span class="fstat-no" title="function not covered" >function() {</span> // Fake the progress bar, for now (since we don't really know who and when this message will be handled)</span>
<span class="cstat-no" title="statement not covered" >    self.refreshingProgressBar.stop();</span>
  }, 100);
<span class="cstat-no" title="statement not covered" >  return true;</span>
}
<span class="cstat-no" title="statement not covered" >RefreshButton.prototype.updateNode = <span class="fstat-no" title="function not covered" >function(parentElement) {</span></span>
<span class="cstat-no" title="statement not covered" >  ko.renderTemplate('refreshbutton', this, {}, parentElement);</span>
}
&nbsp;
