...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ungit/node_modules/ungit/components/progressBar/progressBar.bundle.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ungit/node_modules/ungit/components/progressBar/progressBar.bundle.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ungit/node_modules/ungit/components/progressBar/</a> &#187; progressBar.bundle.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >components.register('progressBar', <span class="fstat-no" title="function not covered" >function(args) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new ProgressBarViewModel(args.predictionMemoryKey, args.fallbackPredictedTimeMs, args.temporary);</span>
});
&nbsp;
<span class="cstat-no" title="statement not covered" >var ProgressBarViewModel = <span class="fstat-no" title="function not covered" >function(predictionMemoryKey, fallbackPredictedTimeMs, temporary) {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  if (fallbackPredictedTimeMs === undefined) <span class="cstat-no" title="statement not covered" >fallbackPredictedTimeMs = 1000;</span></span>
<span class="cstat-no" title="statement not covered" >  this.temporary = temporary;</span>
<span class="cstat-no" title="statement not covered" >  this.style = ko.observable();</span>
<span class="cstat-no" title="statement not covered" >  this.running = ko.observable(false);</span>
<span class="cstat-no" title="statement not covered" >  self._width = ko.observable(0);</span>
<span class="cstat-no" title="statement not covered" >  self._opacity = ko.observable(1);</span>
<span class="cstat-no" title="statement not covered" >  self._widthSpeed = ko.observable(0);</span>
<span class="cstat-no" title="statement not covered" >  self._opacitySpeed = ko.observable(0);</span>
<span class="cstat-no" title="statement not covered" >  self._animationState = ko.observable('running');</span>
<span class="cstat-no" title="statement not covered" >  this.style = ko.computed(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    return 'width: ' + self._width() + '%; ' + </span>
...
<span class="cstat-no" title="statement not covered" >  this.predictionMemoryKey = 'predict-' + predictionMemoryKey;</span>
<span class="cstat-no" title="statement not covered" >  this.isFirstRun = ko.observable(false);</span>
<span class="cstat-no" title="statement not covered" >  this.fallbackPredictedTimeMs = fallbackPredictedTimeMs;</span>
}
<span class="cstat-no" title="statement not covered" >ProgressBarViewModel.prototype.updateNode = <span class="fstat-no" title="function not covered" >function(parentElement) {</span></span>
<span class="cstat-no" title="statement not covered" >  ko.renderTemplate(this.temporary ? 'temporaryProgressBar' : 'progressBar', this, {}, parentElement);</span>
}
<span class="cstat-no" title="statement not covered" >ProgressBarViewModel.prototype.start = <span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  var predictionMs = localStorage.getItem(this.predictionMemoryKey);</span>
<span class="cstat-no" title="statement not covered" >  if (!predictionMs || isNaN(predictionMs)) {</span>
<span class="cstat-no" title="statement not covered" >    this.isFirstRun(true);</span>
<span class="cstat-no" title="statement not covered" >    predictionMs = this.fallbackPredictedTimeMs;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    predictionMs = parseInt(predictionMs);</span>
  }
<span class="cstat-no" title="statement not covered" >  this.predictionMs = predictionMs;</span>
...
<span class="cstat-no" title="statement not covered" >  this._opacitySpeed(0);</span>
<span class="cstat-no" title="statement not covered" >  this._widthSpeed(0);</span>
<span class="cstat-no" title="statement not covered" >  this._animationState('running');</span>
<span class="cstat-no" title="statement not covered" >  this.running(true);</span>
<span class="cstat-no" title="statement not covered" >  this.startMs = Date.now();</span>
<span class="cstat-no" title="statement not covered" >  this.pausedMs = 0;</span>
...
<span class="cstat-no" title="statement not covered" >    predictionMs = Math.max(500, predictionMs);</span>
<span class="cstat-no" title="statement not covered" >    self._width(80);</span>
<span class="cstat-no" title="statement not covered" >    self._widthSpeed(predictionMs);</span>
  }, 1);
}
&nbsp;
<span class="cstat-no" title="statement not covered" >ProgressBarViewModel.prototype.pause = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  this._animationState('paused');</span>
<span class="cstat-no" title="statement not covered" >  this.pauseStartMs = Date.now();</span>
}
<span class="cstat-no" title="statement not covered" >ProgressBarViewModel.prototype.unpause = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  this._animationState('running');</span>
<span class="cstat-no" title="statement not covered" >  this.pausedMs += Date.now() - this.pauseStartMs;</span>
}
<span class="cstat-no" title="statement not covered" >ProgressBarViewModel.prototype.stop = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  var elapsedMs = Date.now() - this.startMs - this.pausedMs;</span>
<span class="cstat-no" title="statement not covered" >  var newPrediction;</span>
<span class="cstat-no" title="statement not covered" >  if (self.isFirstRun()) {</span>
<span class="cstat-no" title="statement not covered" >    self.isFirstRun(false);</span>
<span class="cstat-no" title="statement not covered" >    newPrediction = elapsedMs;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    newPrediction = elapsedMs * 0.1 + self.predictionMs * 0.9;</span>
  }
<span class="cstat-no" title="statement not covered" >  localStorage.setItem(self.predictionMemoryKey, newPrediction.toString());</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  self._width(100);</span>
<span class="cstat-no" title="statement not covered" >  self._widthSpeed(300);</span>
<span class="cstat-no" title="statement not covered" >  setTimeout(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    self._opacity(0);</span>
<span class="cstat-no" title="statement not covered" >    self._opacitySpeed(300);</span>
<span class="cstat-no" title="statement not covered" >    setTimeout(<span class="fstat-no" title="function not covered" >function() {</span></span>
