...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ungit/node_modules/ungit/components/login/login.bundle.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ungit/node_modules/ungit/components/login/login.bundle.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ungit/node_modules/ungit/components/login/</a> &#187; login.bundle.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var signals = require('signals');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >components.register('login', <span class="fstat-no" title="function not covered" >function(args) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new LoginViewModel(args.server);</span>
});
&nbsp;
<span class="cstat-no" title="statement not covered" >var LoginViewModel = <span class="fstat-no" title="function not covered" >function(server) {</span></span>
...
<span class="cstat-no" title="statement not covered" >  this.loggedIn = new signals.Signal();</span>
...
<span class="cstat-no" title="statement not covered" >  this.loginError = ko.observable();</span>
<span class="cstat-no" title="statement not covered" >  this.server.getPromise('/loggedin')</span>
    .then(<span class="fstat-no" title="function not covered" >function(status) {</span>
<span class="cstat-no" title="statement not covered" >      if (status.loggedIn) {</span>
<span class="cstat-no" title="statement not covered" >        self.loggedIn.dispatch();</span>
<span class="cstat-no" title="statement not covered" >        self.status('loggedIn');</span>
      } else {
<span class="cstat-no" title="statement not covered" >        self.status('login');</span>
      }
    }).catch(<span class="fstat-no" title="function not covered" >function(err) {</span> });
}
<span class="cstat-no" title="statement not covered" >LoginViewModel.prototype.updateNode = <span class="fstat-no" title="function not covered" >function(parentElement) {</span></span>
<span class="cstat-no" title="statement not covered" >  ko.renderTemplate('login', this, {}, parentElement);</span>
}
<span class="cstat-no" title="statement not covered" >LoginViewModel.prototype.login = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var self = this;</span>
<span class="cstat-no" title="statement not covered" >  this.server.postPromise('/login', { username: this.username(), password: this.password() }).then(<span class="fstat-no" title="function not covered" >function(res) {</span></span>
<span class="cstat-no" title="statement not covered" >    self.loggedIn.dispatch();</span>
<span class="cstat-no" title="statement not covered" >    self.status('loggedIn');</span>
  }).catch(<span class="fstat-no" title="function not covered" >function(err) {</span>
<span class="cstat-no" title="statement not covered" >    if (err.res.body.error) {</span>
<span class="cstat-no" title="statement not covered" >      self.loginError(err.res.body.error);</span>
    } else {
