...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ungit/node_modules/ungit/components/commitdiff/commitdiff.bundle.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ungit/node_modules/ungit/components/commitdiff/commitdiff.bundle.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ungit/node_modules/ungit/components/commitdiff/</a> &#187; commitdiff.bundle.js</div>
</div>
<div class="body">
...
80
81
82</td><td class="line-coverage"><span class="cline-any cline-yes">10</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >components.register('commitDiff', <span class="fstat-no" title="function not covered" >function(args) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new CommitDiff(args);</span>
});
&nbsp;
<span class="cstat-no" title="statement not covered" >var CommitDiff = <span class="fstat-no" title="function not covered" >function(args) {</span></span>
<span class="cstat-no" title="statement not covered" >  this.commitLineDiffs = ko.observableArray();</span>
...
<span class="cstat-no" title="statement not covered" >  this.showDiffButtons = ko.observable(!args.textDiffType);</span>
<span class="cstat-no" title="statement not covered" >  this.textDiffType = args.textDiffType = args.textDiffType || components.create('textdiff.type');</span>
<span class="cstat-no" title="statement not covered" >  this.wordWrap = args.wordWrap = args.wordWrap || components.create('textdiff.wordwrap');</span>
<span class="cstat-no" title="statement not covered" >  this.whiteSpace = args.whiteSpace = args.whiteSpace || components.create('textdiff.whitespace');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  args.fileLineDiffs.shift(); </span> // remove first line that has "total"
<span class="cstat-no" title="statement not covered" >  this.loadFileLineDiffs(args);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >CommitDiff.prototype.updateNode = <span class="fstat-no" title="function not covered" >function(parentElement) {</span></span>
<span class="cstat-no" title="statement not covered" >  ko.renderTemplate('commitdiff', this, {}, parentElement);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >CommitDiff.prototype.loadFileLineDiffs = <span class="fstat-no" title="function not covered" >function(args) {</span></span>
<span class="cstat-no" title="statement not covered" >  var tempCommitLineDiffs = [];</span>
<span class="cstat-no" title="statement not covered" >  var lineDiffLength = this.commitLineDiffs().length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  args.fileLineDiffs.slice(lineDiffLength === 0 ? 0 : lineDiffLength + 1, this.maxNumberOfFilesShown).forEach(<span class="fstat-no" title="function not covered" >function(fileLineDiff) {</span></span>
<span class="cstat-no" title="statement not covered" >    tempCommitLineDiffs.push(new CommitLineDiff(args, fileLineDiff));</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.commitLineDiffs(this.commitLineDiffs().concat(tempCommitLineDiffs));</span>
}
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var CommitLineDiff = <span class="fstat-no" title="function not covered" >function(args, fileLineDiff) {</span></span>
<span class="cstat-no" title="statement not covered" >  this.added = ko.observable(fileLineDiff[0]);</span>
<span class="cstat-no" title="statement not covered" >  this.removed = ko.observable(fileLineDiff[1]);</span>
<span class="cstat-no" title="statement not covered" >  this.fileName = ko.observable(fileLineDiff[2]);</span>
<span class="cstat-no" title="statement not covered" >  this.fileType = fileLineDiff[3];</span>
...
<span class="cstat-no" title="statement not covered" >  this.specificDiff = ko.observable(this.getSpecificDiff());</span>
};
<span class="cstat-no" title="statement not covered" >exports.CommitLineDiff = CommitLineDiff;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >CommitLineDiff.prototype.getSpecificDiff = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  return components.create(this.fileType + 'diff', {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >CommitLineDiff.prototype.fileNameClick = <span class="fstat-no" title="function not covered" >function() {</span></span>
